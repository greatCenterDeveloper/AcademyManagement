...
class StudentManagementCounselAdapter(val context:Context, val counselCurrentArr:MutableList<CounselCurrent>)
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        // 학생 이름
        holder.binding.tvName.text = cca.studentName
                                ...
                                .counselDelete(
                                    ...
                                    override fun onResponse(
                                        ...
                                        if(message?.contains("완료") ?: false) {
                                            ...
                                            this@StudentManagementCounselAdapter.notifyItemRemoved(holder.adapterPosition)
                                        }
                                    }
