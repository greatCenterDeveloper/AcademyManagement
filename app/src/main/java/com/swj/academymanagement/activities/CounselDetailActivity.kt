            ...
            RetrofitHelper.getRetrofitInstance().create(RetrofitCounselService::class.java)
                .counselInsert(counselCurrent).enqueue(object :Callback<String> {
                    override fun onResponse(call: Call<String>, response: Response<String>) {
                        ...
                        Toast.makeText(this@CounselDetailActivity, message, Toast.LENGTH_SHORT).show()

                        if(message?.contains("완료") ?: false) { // 넘어오는 문자열 : 상담 작성 완료 이므로..
                            val intent = Intent(this@CounselDetailActivity, CounselActivity::class.java)
                    ...
                    override fun onFailure(call: Call<String>, t: Throwable) {
                        Toast.makeText(this@CounselDetailActivity, "error : ${t.message}", Toast.LENGTH_SHORT).show()
                    }
                })
        }
