...
// 학생 권한 노트 내용 수정 화면
class ClassNoteDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 학생 수업 노트 리스트에서 노트 수정 화면으로 이동시 화면 전환 효과
        ...
        binding.btnSave.setOnClickListener {
            // 학생 수업 노트 테이블의 num ( auto_increment -> primary key )
            ...
            // 수정된 내용 학생 수업 노트 테이블에 적용
            db.execSQL("UPDATE student_note SET title=?, content=? WHERE num=?", arrayOf(title, content, num))
